...
MapRenderer::MapRenderer(jni::JNIEnv& _env,
                         ...
                         jni::jint glyphsRasterizationMode_,
                         const jni::String& localIdeographFontFamily_)
    : javaPeer(_env, obj),
      pixelRatio(pixelRatio_),
      glyphsRasterizationMode(glyphsRasterizationMode_),
...
#define METHOD(MethodPtr, name) jni::MakeNativePeerMethod<decltype(MethodPtr), (MethodPtr)>(name)
    ...
    jni::RegisterNativePeer<MapRenderer>(env, javaClass, "nativePtr",
                                         jni::MakePeer<MapRenderer, const jni::Object<MapRenderer>&, jni::jfloat, jni::jint, const jni::String&>,
